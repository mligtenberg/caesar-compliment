...
// Only correct for a face that actually gets that roll; anything drawing the
// back standalone wants renderFinishedPostcardBackLandscape() instead.
...
// with no transform of its own — for the drifting background cards, which
// tumble freely and so can't rely on a fixed corrective roll.
